...
@include('partials/_search')
    ...
    <a href="/laragigs/public" class="inline-block text-black ml-4 mb-4"><i class="fa-solid fa-arrow-left"></i>
        Back
    </a>
        <div class="mx-4">
            ...
            <x-card class="!mt-4 !p-2 !flex !space-x-6">
                ...
                <form action="/laragigs/public/listings/{{$listing->id}}" method="POST">
                    @csrf {{-- Protects from cross site scripting --}}
                    @method('DELETE')
